...
use App\Models\PolicyGovAgenModel;
use App\Repositories\BaseRepository;
use App\Repositories\CommonRepository;

class PolicyGovAgenRepository extends BaseRepository
{
    use CommonRepository;

    public function model()
    {
        return PolicyGovAgenModel::class;
    }
    ...
    public function getPolicy($where, $column = ['*'])
    {
