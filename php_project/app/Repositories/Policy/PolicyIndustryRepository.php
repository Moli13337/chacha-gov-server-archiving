...
use App\Models\PolicyIndustryModel;
use App\Repositories\BaseRepository;
use App\Repositories\CommonRepository;

class PolicyIndustryRepository extends BaseRepository
{
    use CommonRepository;

    public function model()
    {
        return PolicyIndustryModel::class;
    }
    ...
    public function list($policy_id)
    {
        return $this->model->where('policy_id', $policy_id)->get()->toArray();
    }
}