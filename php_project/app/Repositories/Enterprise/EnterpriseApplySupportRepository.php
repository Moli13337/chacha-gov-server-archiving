...
use App\Models\EnterpriseApplyInfoModel;
use App\Models\EnterpriseApplySupportModel;
use App\Repositories\BaseRepository;
use App\Repositories\CommonRepository;

class EnterpriseApplySupportRepository extends BaseRepository
{
    use CommonRepository;
    public function model()
    {
        return EnterpriseApplySupportModel::class;
    }
