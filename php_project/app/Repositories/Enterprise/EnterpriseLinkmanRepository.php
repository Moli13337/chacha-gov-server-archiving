...
use App\Models\EnterpriseLinkmanModel;
use App\Repositories\BaseRepository;
use App\Repositories\CommonRepository;

class EnterpriseLinkmanRepository extends BaseRepository
{
    use CommonRepository;
    public function model()
    {
        return EnterpriseLinkmanModel::class;
    }
    ...
    public function storeBatch($data)
    {
        foreach ($data as $key => $value) {
            $data[$key] = array_merge($value,returnCreatedUpdatedAt());
        }
