...
//     只记录变更的值
    ...
    public function getDescriptionForEvent(string $eventName): string
    {
        ...
        $content = '';
        $base = array_get(trans('constant.activity_subject_type'), ACTIVITY_SUBJECT_TYPE['agent_comment'], '');
        ...
        if ($type == ACTIVITY_TYPE['created']) {
            ...
            $columnName = trans('mysqlColumn.agentComment');
            $temp_content = [];
    ...
    public function tapActivity(Activity $activity, $eventName)
    {
        ...
        $activity->subject_type_id = ACTIVITY_SUBJECT_TYPE['agent_comment'];
